        ...
        <div className="cart-summary-col">
          <div className="cart-summary">
            ...
            <div className="summary-note">
              Inclusive of all taxes. EMI available from ₹{Math.round(grandTotal / 12).toLocaleString("en-IN")}/mo
            </div>
      ...
      <div className="cart-item__info">
        ...
        <div className="cart-item__footer">
          <div className="qty-control">
            ...
            <button className="qty-btn" onClick={() => onQty(item.quantity + 1)}>
              +
            </button>
          </div>
...
function BackArrow() {
  return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/></svg>;
}
function TrashIcon() {
  return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"/></svg>;
}